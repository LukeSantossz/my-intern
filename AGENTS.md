...
The development standards live in the `.standards` submodule (my-framework). This file
adapts the framework's reviewer brief to this repository's submodule layout.
